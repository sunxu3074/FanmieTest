...
public abstract class FileCallBack extends Callback<File>
{
    ...
    @Override
    public File parseJsonResponse(String response, int id) throws Exception {
        return null;
    }

    @Override
    public File parseCacheResponse(String response, int id) throws Exception {
        return null;
    }

    @Override
    public void onCacheResponse(File response) {
