...
public class DiskLruCacheHelper {
    ...
    //版本升级会清除掉缓存，所以不取系统版本号，缓存自用版本号，需要清除可+1
...
//            return file;
//        } else {
//            sb.append(Environment.getExternalStorageDirectory().getPath()).append("/house/").append("/cache");
//
//            String path = sb.toString();
//            File next = new File(path);
//            if (!next.exists()){
//                boolean aa =next.mkdir();
//                Log.e("x","aa           ==   "+aa);
//            }
//
//            return next;
